...
class ConcurrentWithdrawIntegrationTest {
    ...
    void 동시_전액_출금시_하나만_성공해야_한다() {
        ...
        }, InsufficientBalanceException.class, ObjectOptimisticLockingFailureException.class);
    ...
    void 다중_스레드_동시_출금시_데이터_정합성_유지() {
        ...
        ExecutionResult result = ConcurrencyRunner.run(threadCount, () -> {
            ...
            WithdrawCommand command = WithdrawCommand.of(
                    accountId, withdrawAmount, "Multi withdraw", businessRefId);
            withdrawService.withdraw(command);
        }, InsufficientBalanceException.class, ObjectOptimisticLockingFailureException.class);
        ...
        fixture.assertBalance(accountId,
