...
1.  **Why-Driven Engineering**: 모든 기술 선택(Kotlin, MSA, Kafka, Redis 등)은 대안과의 비교, 트레이드오프 분석, 그리고 실험 데이터에 기반합니다.
...
*   **Week 15: 캐싱 전략 및 성능 최적화**
    ...
    *   [ ] JVM GC Tuning 및 HikariCP 설정 최적화.
...
*   [ ] **Java/Kotlin, Spring Framework**: 프로젝트 전체 기반 기술.
